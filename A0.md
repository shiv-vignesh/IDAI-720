...
- Log into any of the three [gpu clusters](https://wiki.cs.rit.edu/index.php/Using_gpu_nodes) with your CS Account:
```
...
```
- Install [tensorflow-gpu](https://www.tensorflow.org/install/pip) on Linux
```
